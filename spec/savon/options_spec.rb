...
describe "Options" do
  ...
  context "global :ssl_cert_key" do
    it "sets the cert key to use" do
      cert_key = File.open(File.expand_path("spec/fixtures/ssl/client_key.pem", @gem_dir)).read
  ...
  context "global :ssl_cert" do
    it "sets the cert to use" do
      cert = File.open(File.expand_path("spec/fixtures/ssl/client_cert.pem", @gem_dir)).read
  ...
  context "global :ssl_ca_cert" do
    it "sets the ca cert file to use" do
      ca_cert = File.open(File.expand_path("spec/fixtures/ssl/client_cert.pem", @gem_dir)).read
